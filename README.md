...
```css
PLAY RECAP *************************************************************************************************************************************************************************************************************************************************  appserver                  : ok=2    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
```
...
```css
PLAY RECAP *************************************************************************************************************************************************************************************************************************************************  appserver                  : ok=2    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
```
...
Прошла проверка только второго хоста, т.к. первый выключен и его внешний ip не передается в выводе команды ```css yc compute instance list```
